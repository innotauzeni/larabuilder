          ...
          <div className="bg-slate-900/50 border border-slate-805 rounded-xl p-6 shadow-sm space-y-5">
            ...
            <div className="pt-3 border-t border-slate-800">
              <button
                ...
                disabled={zipping}
                className="w-full bg-indigo-600 hover:bg-indigo-700 active:bg-indigo-805 disabled:opacity-50 text-white font-semibold rounded-xl py-3 px-6 shadow-md transition-all flex items-center justify-center gap-2 cursor-pointer"
              >
                {zipping ? (
                  <>
